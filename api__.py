...
class FleetMasterResponse(BaseModel):
    message: str
    fleet_master: Optional[FleetMasterSchema] = None
...
def delete_file(request, model_name: str, instance_id: int, file_index: int):
    ...
    #             Attachment.objects.filter(
    #                 fleet_master=instance,
    #                 FleetNumber=instance.FLEET_CONTROL_NO,
    #                 file__icontains=file_path.split('/')[-1]
    #             ).delete()
    ...
    #         if hasattr(instance, 'FLEET_CONTROL_NO'):
    #             Attachment.objects.filter(
    #                 FLEET_CONTROL_NO=instance.FLEET_CONTROL_NO,
    #                 file__icontains=file_path.split('/')[-1]
    #             ).delete()
...
@api.delete("/delete-file-commercial/{model_name}/{instance_id}/{file_index}")
def delete_file(request, model_name: str, instance_id: int, file_index: int):
    try:
        model_map = {
            'XXGTD_INSURANCE_INFO': XXGTD_INSURANCE_INFO,
            'XXGTD_REGISTRATION_INFO': XXGTD_REGISTRATION_INFO,
            'XXGTD_ROAD_TOLL_INFO': XXGTD_ROAD_TOLL_INFO,
            'XXGTD_ALLOCATION_INFO': XXGTD_ALLOCATION_INFO,
        }
        ...
        attachment_field = {
            'XXGTD_INSURANCE_INFO': 'InsurancePolicAattachment',
            'XXGTD_REGISTRATION_INFO': 'RegCardAttachment',
            'XXGTD_ROAD_TOLL_INFO': 'RoadtollAttachments',
            'XXGTD_ALLOCATION_INFO': 'attachment',
        }.get(model_name.lower())
        ...
        CommercialAttachment.objects.filter(
            COMM_CONTROL_NO=instance.COMM_CONTROL_NO,
            file__icontains=file_path.split('/')[-1]
        ).delete()
