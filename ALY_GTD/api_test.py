...
#         current_status = data_dict.get('STATUS') or data_dict.get('commercial_master', {}).get('STATUS', 'N/A')
#         data_dict['STATUS'] = current_status
#         data_dict['CREATION_DATE'] = data_dict.get('CREATION_DATE', data_dict.get('CREATION_DATE', 'N/A'))
#         data_dict['LAST_UPDATE_DATE'] = data_dict.get('CREATION_DATE', data_dict.get('LAST_UPDATE_DATE', 'N/A'))
...
#         # Send email for approver actions or any non-approver submissions (new or modified)
#         if is_approver_action or not is_approver_action:
#             html_message = render_to_string('ALY_GTD/commercial_email.html', context)
#             text_message = strip_tags(html_message)
#             email = EmailMultiAlternatives(
